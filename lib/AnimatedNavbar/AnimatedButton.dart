      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          padding: EdgeInsets.symmetric(
            horizontal:
                (_currentState == ButtonState.SHOW_ONLY_ICON) ? ScreenUtil().setWidth(16) : ScreenUtil().setWidth(48),
            ...
            child: Row(
              ...
              children: <Widget>[
                (_currentState == ButtonState.SHOW_ONLY_ICON ||
                    ...
                    : Container(),
                SizedBox(
                  width: _currentState == ButtonState.SHOW_TEXT_ICON ? ScreenUtil().setHeight(30) : ScreenUtil().setHeight(0),
                ),
                getTextWidget()
              ],
            ),
